# Generated by Django 4.1.7 on 2023-11-15 12:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagenCarnet', models.ImageField(upload_to='')),
                ('f_creacion', models.DateTimeField(default='CURRENT_TIMESTAMP', editable=False)),
                ('f_modificacion', models.DateTimeField(default='CURRENT_TIMESTAMP', editable=False)),
